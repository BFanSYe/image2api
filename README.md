...
用户前台在 v0.2.0 重做为 Aurora 暗色主题: 粉紫液态 mesh 背景动效, Geist Sans / Mono 字体, 1px 描边玻璃卡.

<table>
  <tr>
    <td width="50%"><img src="docs/images/studio.png" alt="Studio 创作页" /></td>
    <td width="50%"><img src="docs/images/inspire.png" alt="灵感库瀑布流" /></td>
  </tr>
  <tr>
    <td align="center"><sub>Studio 创作页 (桌面)</sub></td>
    <td align="center"><sub>灵感库瀑布流 (桌面)</sub></td>
  </tr>
</table>

<p align="center">
  <img src="docs/images/inspire-mobile.png" alt="灵感库移动端" width="280" />
  <br /><sub>灵感库 (移动端)</sub>
</p>
...
- 灵感库: 全站作品按生成时间汇聚到 `/inspire` 公开瀑布流页, 支持按 image / video 筛选, 一键复用提示词. 默认所有用户的成功生成结果都进入灵感库, 升级到含 `20260517190000_inspire_default_public` 迁移的版本会把历史数据回灌为公开. 如需关闭, 见 [部署快速开始](docs/DEPLOYMENT_QUICKSTART.md).
- OpenAI 兼容 API:
  - `GET /v1/models`
...
- 用户端 API:
  - `GET /api/v1/inspire/feed?kind=image|video&cursor=&page_size=` 灵感库游标分页 (无需登录).
